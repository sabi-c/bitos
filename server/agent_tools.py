...
DEVICE_TOOLS = [
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "reminder_at": {"type": "string", "description": "ISO datetime or null to clear."},
    ...
    },
    {
        "name": "get_task",
        "description": (
            "Get a single task with its subtasks. Returns full task details."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    },
    {
        "name": "set_reminder",
        "description": (
            "Set or update a reminder time for a task. The device will get a "
