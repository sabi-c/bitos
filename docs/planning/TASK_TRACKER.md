...
| P8-004 | Phase 8 | WS-K Agent Modes | Inject agent-mode system prompts into server chat flow | GPT-5.2-Codex | done | 2026-03-14 | Added mode prompt catalog, /chat agent_mode wiring, device payload wiring, and agent-mode tests |
| P8-004b | Phase 8 | WS-K Agent Modes | Inject live task and battery context into agent-mode prompts | GPT-5.2-Codex | done | 2026-03-14 | Added tasks_today + battery_pct prompt context wiring across device client and server chat request |
