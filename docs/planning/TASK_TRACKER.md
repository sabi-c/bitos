...
| P0-001 | Phase 0 | Asset Recovery | Recover/migrate missing HTML UI reference artifacts (`bitos-screen-proto.html`, multi-screen prototype `index.html`) into `docs/reference-ui/` | GPT-5.2-Codex | in_progress | 2026-03-14 | Added canonical `docs/reference-ui/README.md`; waiting for externally-added files to sync into this workspace |
