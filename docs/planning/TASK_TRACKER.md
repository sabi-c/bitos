...
|---|---|---|---|---|---|---|---|
| P5-012e | Phase 5 | Companion | Pair dashboard page + keyboard input send path | GPT-5.2-Codex | done | 2026-03-14 | Added companion/pair.html, companion/ble.js sendKeyboardInput, and setup done-screen dashboard link |
| P6-001 | Phase 6 | Power UX | Five-press graceful shutdown overlay + state save + backend shutdown hook | GPT-5.2-Codex | done | 2026-03-14 | Added power gesture detection, PowerOverlay, /shutdown endpoint, and Makefile shutdown/reboot helpers |
