...
| CODEX-UI-002 | Phase 11 | Remote Control | Build vertical slice endpoints for session/turn/event/approval flows | GPT-5.2-Codex | todo | 2026-03-20 | Next implementation slice: scaffold `server/codex_app_client.py` + `server/endpoints/codex_remote.py` with focused tests |
